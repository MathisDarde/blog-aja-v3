...
const GettersContext = createContext<GettersContextInterface | undefined>(undefined);

export const GettersProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        ...
        const uniqueMap = new Map<string, { id_methode: string; typemethode: string; keywords: string }>();
        ...
        const uniqueKeywords = Array.from(uniqueMap.values()).map(({ id_methode, typemethode, keywords }) => ({
          id_methode,
          typemethode,
