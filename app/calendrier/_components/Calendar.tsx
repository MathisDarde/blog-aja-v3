...
export default function Calendar({ matches }: { matches: MatchAPI[] }) {
  ...
  return (
    <>
      {width > 1024 ? (
        <div className="p-6 lg:w-[950px] xl:w-[1200px] 2xl:w-[1300px] bg-white mx-auto">
          {/* Header mois */}
        ...
        <div className="p-1 sm:p-4 grid grid-cols-1 max-w-[400px] md:max-w-full mx-auto md:grid-cols-2 gap-4">
          {matches.map((match, idx) => {
            ...
            return (
              ...
              >
                <p className="underline text-xs mb-2">
