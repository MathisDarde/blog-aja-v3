...
export const metadata: Metadata = {
  title: "Brouillons",
  description: "Découvrez les brouillons d'articles en cours de rédaction sur Mémoire d'Auxerrois, offrant un aperçu des futures histoires et contenus liés à l'AJ Auxerre.",
};
