  ...
  return (
    <div className="flex flex-col pt-4">
      ...
      <div className="mt-4 text-center">
        <p className="font-semibold text-lg font-Bai_Jamjuree">Coach : {methode.coach} <span className="text-sm font-medium">({methode.systeme})</span></p>
      </div>

      {/* Remplaçants */}
      <div className="mt-4">
        <p className="font-semibold font-Bai_Jamjuree text-left text-lg">Remplaçants :</p>
          ...
          {methode.remplacants.map((remp, index) => (
            <li key={index} className="flex items-center gap-2">
              ...
              <Image
                ...
                src={remp[1]}
                alt=""
                className="w-5 h-[12px] object-cover border border-black"
              />
            </li>
          ))}
        </ul>
